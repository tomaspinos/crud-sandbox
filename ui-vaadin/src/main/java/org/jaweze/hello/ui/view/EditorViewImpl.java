...
public class EditorViewImpl extends VerticalLayout implements View, EditorView {
    ...
    private final Logger logger = LoggerFactory.getLogger(EditorViewImpl.class);

    public EditorViewImpl(EditorViewListener listener, Messages messages) {
